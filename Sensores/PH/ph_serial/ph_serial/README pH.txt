...
Que el Arduino pueda manejar los comandos mediante JSON, entregue los datos en JSON
y que se mantenga el que se pueda ver en el monitor serial lo que esta sucediendo